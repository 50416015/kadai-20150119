...
public class CancelReservation extends Dialog implements ActionListener, WindowListener,ItemListener
{
	boolean canceled;        //キャンセルされたら true 予約キャンセルボタンのときは false
    // パネル
    Panel panelNorth;
    Panel panelMid;
    Panel panelSouth;
    ...
    Button buttonOK;
    Button buttonCancel;
    public CancelReservation(Frame owner) {
